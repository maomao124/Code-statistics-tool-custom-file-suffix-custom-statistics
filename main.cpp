...
int main()
{
	...
	char choose;
	cout << "                                    欢迎使用!!!" << endl;
	cout << "                     代码统计工具 自定义文件后缀名 自定义统计" << endl;
	cout << endl;
...
#define jianju 30
	...
	cout << endl;
	ofstream finalout("自定义后缀名_自定义统计_结果.txt", ios::app);
	...
	if (choose == '1')
	{
		system("start 自定义后缀名_自定义统计_结果.txt");
	}
	else if (choose == '2')
	{
